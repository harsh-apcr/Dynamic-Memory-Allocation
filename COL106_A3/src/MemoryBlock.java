...
public class MemoryBlock {
    ...
    public MemoryBlock(int address, int size, int key) { // Constructor for the Dictionary element
        this.key = key;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(key, address, size);
    }

    @Override
    public String toString() {
        return "[MemoryBlock:" + this.address + "-->" + (this.address+this.size)+ "]";
    }
